...
<!-- Morris.js charts -->
<!-- <script src="<?php //echo $base ?>lib/raphael/raphael.min.js"></script>
<script src="<?php //echo $base ?>lib/morris.js/morris.min.js"></script> -->
<!-- Sparkline -->
<!-- <script src="<?php //echo $base ?>lib/jquery-sparkline/dist/jquery.sparkline.min.js"></script> -->
<!-- jQuery Knob Chart -->
...
<!-- <script src="<?php //echo $base ?>lib/bootstrap-daterangepicker/daterangepicker.js"></script> -->
<!-- datepicker -->
<script src="<?php echo $base ?>lib/bootstrap-datepicker/js/bootstrap-datepicker.min.js"></script>
<!-- Slimscroll -->
<!-- <script src="<?php //echo //$base ?>lib/jquery-slimscroll/jquery.slimscroll.min.js"></script> -->
<!-- FastClick -->
<!-- <script src="<?php //echo $base ?>lib/fastclick/lib/fastclick.js"></script> -->
<!-- AdminLTE App -->
