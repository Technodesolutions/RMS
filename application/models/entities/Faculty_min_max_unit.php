<?php
		...
		/**
		* This class  is automatically generated based on the structure of the table. And it represent the model of the faculty_min_max_unit table.
		*/
		class Faculty_min_max_unit extends Crud
		{
protected static $tablename='Faculty_min_max_unit';
...
static $typeArray = array('min_unit'=>'int','max_unit'=>'int','session_id'=>'int','faculty_id'=>'int');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/
static $labelArray=array('ID'=>'','min_unit'=>'','max_unit'=>'','session_id'=>'','faculty_id'=>'');
...
static $tableAction=array('enable'=>'getEnabled','delete'=>'delete/faculty_min_max_unit','update'=>'edit/faculty_min_max_unit');
