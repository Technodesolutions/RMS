<?php
		...
		/**
		* This class  is automatically generated based on the structure of the table. And it represent the model of the student_min_max_unit table.
		*/
		class Student_min_max_unit extends Crud
		{
protected static $tablename='Student_min_max_unit';
...
static $typeArray = array('min_unit'=>'float','max_unit'=>'float','session_id'=>'int','student_biodata_id'=>'int');
/*this is a dictionary that map a field name with the label name that will be shown in a form*/
static $labelArray=array('ID'=>'','min_unit'=>'','max_unit'=>'','session_id'=>'','student_biodata_id'=>'');
...
static $tableAction=array('enable'=>'getEnabled','delete'=>'delete/student_min_max_unit','update'=>'edit/student_min_max_unit');
